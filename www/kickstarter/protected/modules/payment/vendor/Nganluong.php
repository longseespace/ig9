...
class Nganluong
{
  ...
  // Mã merchante site
  private $merchant_site_code = '27614';  // Biến này được nganluong.vn cung cấp khi bạn đăng ký merchant site

  // Mật khẩu bảo mật
  private $secure_pass= 'ig9rock!'; // Biến này được nganluong.vn cung cấp khi bạn đăng ký merchant site

  private $return_url = 'http://ig9.vn/payment/default/nganluongcallback';

  private $receiver = 'support@ig9.vn';

  //Hàm xây dựng url, trong đó có tham số mã hóa (còn gọi là public key)
  public function buildCheckoutUrl($transaction_info, $order_code, $price)
  {

    // Mảng các tham số chuyển tới nganluong.vn
    $arr_param = array(
      'merchant_site_code'=>  strval($this->merchant_site_code),
      'return_url'    =>  strtolower(urlencode($this->return_url)),
