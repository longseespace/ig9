<?php 
	...
	$ac->registerAssetGroup(array('message.less', 'message.js'), $baseUrl);
?>
...
<div class='container' id='message-inbox'>
	...
	<div class='content'>
		...
		<div id='message-detail'>
			...
			<div class='message'>
				<div class='header'>
					<h3 id='message-subject'>Happy 2013, and let’s win a Crunchie!</h3>
					<span id='message-sender'>LinhSex</span> &mdash; <span id='message-time'>Jan 25 (3 days ago)</span>
				</div>
				<div class='body'>
					<p id='message-body'>
						Dear Courserians,

						We hope your 2013 is off to a phenomenal start! We have loads of new courses rolling out this month and even more in February. Go ahead and make a list of your learning goals and share them with your friends; you might be surprised by who else you’ll find enrolled in your classes!

						We are also very grateful and thrilled to have been nominated for two Crunchie Awards: Best Education Startup and Best New Startup. Please take a moment and vote for us. Voting closes tonight! Thank you so much for your support.
					</p>
				</div>
				<div id='message-reply'>
					<textarea id='reply-editor'></textarea>
				</div>
			</div>
		</div>

		<div id="message-compose" style='display: block;'>
			<div class='toolbar'>
				<div class='buttons'>
