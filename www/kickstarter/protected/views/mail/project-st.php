  ...
  <tr>
    <td valign="top" width="100%" style="text-align: left; padding: 0; font-family: Helvetica, sans-serif; font-size: 13px; line-height: 23px; color: #444444">
      <div class="hubspot-editable">
        ...
        <p>Dự án <a href="{project-permalink}" style='text-decoration: none; color: #FF9800;'><b>Video nhạc kịch Never give up 2</b></a> do <b>{project-owner}</b> thực hiện đã chính thức gọi vốn thành công từ cộng đồng trên IG9.vn</p>

        <p>IG9 và <b>{project-owner}</b> xin cảm ơn sự hỗ trợ của bạn. Nhờ sự hỗ trợ của các bạn, dự án đã có thể trở thành hiện thực.</p>

        <p>Như đã hứa, <b>{project-owner}</b> xin gửi đến bạn những phần quà tương ứng với số tiền bạn hỗ trợ cho dự án gồm:</p>

        <blockquote style='border-left: 2px solid #ccc; margin-left: 0; padding-left: 20px;'>{reward}</blockquote>

        <p>Các phần quà này dự kiến sẽ được <b>{project-owner}</b> chuyển đến bạn vào cuối tháng 6 này.</p>
