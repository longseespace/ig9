  ...
  <tr>
    <td valign="top" width="100%" style="text-align: left; padding: 0; font-family: Helvetica, sans-serif; font-size: 13px; line-height: 23px; color: #444444">
      <div class="hubspot-editable">
        ...
        <p>Dự án <a href="{project-permalink}" style='text-decoration: none; color: #FF9800;'><b>{project-title}</b></a> do <b>Idea Production</b> thực hiện đã chính thức gọi vốn thành công từ cộng đồng trên IG9.vn</p>

        <p>Thay mặt <b>Idea Production</b>, IG9 xin cảm ơn sự hỗ trợ của bạn. Bạn đã góp phần làm nên sự thành công cho dự án. Khoản hỗ trợ của bạn đã giúp tập truyện tranh NEXT đã chính thức được xuất bản.</p>

        <p>Như đã hứa, <b>Idea Production</b> xin gửi đến bạn những phần quà tương ứng với số tiền bạn hỗ trợ cho dự án gồm:</p>

        <blockquote style='border-left: 2px solid #ccc; margin-left: 0; padding-left: 20px;'>{reward}</blockquote>

        <p>Các phần quà này dự kiến sẽ được <b>Idea Production</b> chuyển đến bạn vào giữa tháng 6 này.</p>

        <p>Hãy tiếp tục dõi theo và hỗ trợ cho những dự án thú vị tiếp theo tại <a href="http://ig9.vn" style='color: #FF9800;'>ig9.vn</a> bạn nhé!</p>
