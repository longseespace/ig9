        ...
        <table width='100%'>
          <tr>
            ...
            <td style='font-size: 14px; '>
              <p>Dự án <a href="{project-permalink}" style='text-decoration: none;'><b>{project-title}</b></a> bạn đã hỗ trợ trên trang web <a href="http://ig9.vn">ig9.vn</a> vừa có cập nhật mới! Để xem thêm chi tiết và bình luận, bạn hãy ấn vào link sau.</p>
              <p><a href="{update-permalink}" style='text-decoration: none;'><b>{update-title}</b></a></p>
            </td>
          </tr>
        </table>
